...
SettingsWindow::SettingsWindow() {
  ...
  debuggerSettingsWindow = new DebuggerSettingsWindow;
  ...
  debuggerArea = new QScrollArea;
  debuggerArea->setWidget(debuggerSettingsWindow);
  debuggerArea->setFrameStyle(0);
  debuggerArea->setWidgetResizable(true);
  ...
  tab->addTab(debuggerArea, "Debugger");
